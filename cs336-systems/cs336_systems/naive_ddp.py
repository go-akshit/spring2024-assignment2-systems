...
def get_args():
    ...
    parser.add_argument("--batch_size", type=int, default=4, help="Batch size for the model, default=16")
    parser.add_argument("--d_model", type=int, default=12, help="d_model for the model, default=small i.e. 768")
    parser.add_argument("--d_ff", type=int, default=12, help="d_ff for the model, default=small i.e. 3072")
    parser.add_argument("--num_layers", type=int, default=2, help="num_layers for the model, default=small i.e. 12")
    parser.add_argument("--num_heads", type=int, default=2, help="num_heads for the model, default=small i.e. 12")
